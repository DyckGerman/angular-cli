...
const LibComponentCommand: any = Command.extend({
  name: 'generate-lib-component',
  description: 'Creates a new angular 2 component in the current folder.',
  works: 'everywhere',
...
LibComponentCommand.overrideCore = true;
export default LibComponentCommand;
